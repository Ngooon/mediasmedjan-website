...
<head>
    ...
    <meta name="description" content="Reklamfilmer">
    <meta name="keywords" content="Reklamfilmer">
    <meta name="author" content="Mediasmedjan">
</head>
<body id="contact-site">
    <header>
        <h1>Mediasmedjan UF</h1>
        <div class="center-box">
            <a href="/">
                <h3>Logo</h3>    <!-- Temporary replacement for logo image. -->
                <!-- <img src="./images/logoText.png" alt="" id="header-logo"> -->
                <script>
                    // Change logo if screen is to small
        ...
        <section class="row">
                ...
                <section class="col-5 col-s-6 contact-info">
                    ...
                    <section class="clearfix">
                        ...
                        <a href="mailto:kontakt@mediasmedjan.se">kontakt@mediasmedjan.se</a>
                    </section>
                    <!-- <section class="clearfix">
                        <svg viewBox="0 0 24 24">
                    ...
                    <?php
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                            ...
                            if ($errors == 0) {
                                ...
                                $to = "kontakt@mediasmedjan.se";
                                $subject = "Kontaktformulär från " . $name;
                                $headers = "From: Kontaktformulär <kontakt@mediasmedjan.se>" . "\r\n" .
                                "Reply-To: " . $email . "\r\n" .
    ...
    <footer>
        <h2>
            &copy; 2020
            <script>
                // Write this year if it's not equal to start year.
